...
myApp.myMap = function () {
    ...
    var bounds = [9133613.383852294, 2254280.838186421, 10976663.009864463, 3304831.3549378836];
...
myApp.AddLayers = async function () {
    ...
    myApp.map.addLayer(Outline);
    let l1 = new layerCheckBoxBinding(".layerCollection", Outline, false, true);
    ...
    myApp.map.addLayer(District);
    let l2 = new layerCheckBoxBinding(".layerCollection", District, false, true);

    var Stations = new ol.layer.Tile({
        id: 'Stations',
        title: 'Stations',
        visible: false,
        legendPath: LegendSource + 'Nepal:bangladeshStations',
        source: new ol.source.TileWMS({
            url: datasource,
            hidpi: false,
            params: {
                'VERSION': '1.1.1',
                'LAYERS': 'Nepal:bangladeshStations',
                'TILED': true
            },
            serverType: 'geoserver',
            crossOrigin: 'anonymous'
    ...
    myApp.map.addLayer(Stations);
    let l3 = new layerCheckBoxBinding(".layerCollection", Stations, false, true);


    myApp.HiwatRiverWMSSource = new ol.source.TileWMS({
        url: datasource,
        params: {
            'LAYERS': 'Nepal:bangladeshRiver', 'TILED': true
        },
        serverType: 'geoserver',
        crossOrigin: 'anonymous'
    });
    myApp.HiwatRiver = new ol.layer.Tile({
        id: 'HIWATRiverHKH',
        title: 'HIWAT Rivers',
        legendPath: LegendSource + 'Nepal:bangladeshRiver',
        visible: true,
