...
# from ..app import Streamflowbangladesh
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.streamflowbangladesh"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.streamflowbangladesh.tests.tests"

        To run tests in the StreamflowbangladeshTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.streamflowbangladesh.tests.tests.StreamflowbangladeshTestCase"

        To run only the test_if_tethys_platform_is_great function in the StreamflowbangladeshTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.streamflowbangladesh.tests.tests.StreamflowbangladeshTestCase.test_if_tethys_platform_is_great"
...
class StreamflowbangladeshTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Streamflowbangladesh)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Streamflowbangladesh)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/streamflowbangladesh/')  # The final '/' is essential for all pages/controllers
